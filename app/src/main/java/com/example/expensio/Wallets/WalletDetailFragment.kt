...
class WalletDetailFragment : Fragment(R.layout.fragment_wallet_detail),
    ...
    private lateinit var fab1Label: TextView
    private lateinit var fab3Label: TextView
    ...
    private fun animateFAB() {
        fab1Label = requireActivity().findViewById(R.id.fab1_label)
        fab3Label = requireActivity().findViewById(R.id.fab3_label)
        ...
        if (isFABOpen) {
            ...
            fab1Label.animate().translationX(0f).translationY(0f).alpha(alphaHide).scaleX(scaleHide).scaleY(scaleHide)
            fab3Label.animate().translationX(0f).translationY(0f).alpha(alphaHide).scaleX(scaleHide).scaleY(scaleHide)
            isFABOpen = false
            ...
            fab1Label.animate().translationX(-(distance * Math.sin(Math.toRadians((180.0 - angle) / 2.0))).toFloat()).translationY(-(distance * Math.cos(Math.toRadians((180.0 - angle) / 2.0))).toFloat()).alpha(alphaShow).scaleX(scaleShow).scaleY(scaleShow)
            fab1Label.visibility = View.VISIBLE
            ...
            fab3Label.animate().translationX((distance * Math.sin(Math.toRadians((180.0 - angle) / 2.0))).toFloat()).translationY(-(distance * Math.cos(Math.toRadians((180.0 - angle) / 2.0))).toFloat()).alpha(alphaShow).scaleX(scaleShow).scaleY(scaleShow)
            fab3Label.visibility = View.VISIBLE
